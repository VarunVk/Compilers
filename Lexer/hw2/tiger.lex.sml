...
fun yyAction0 (strm, lastMatch : yymatch) = (yystrm := strm;
      (com_lev := 1; YYBEGIN COMMENT; continue()))
fun yyAction1 (strm, lastMatch : yymatch) = (yystrm := strm;
      (com_lev := !com_lev - 1; if(!com_lev = 0) then YYBEGIN INITIAL else ();  continue()))
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;
      (com_lev := !com_lev + 1; continue()))
...
fun yyAction47 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STR_SEC; str_val:=""; str_pos:=yypos; continue()))
fun yyAction48 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (str_val:= !str_val ^ yytext; continue())
      end
...
fun yyAction56 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; Tokens.STRING(!str_val, !str_pos, yypos+size (!str_val))))
fun yyAction57 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Invalid escape character: " ^ yytext); YYBEGIN INITIAL; Tokens.STRING(!str_val, !str_pos, yypos+size (!str_val)))
      end
fun yyAction58 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos ("string ended with newline: " ^ !str_val); lineNum := !lineNum+1; linePos := yypos :: !linePos; YYBEGIN INITIAL; Tokens.STRING(!str_val, !str_pos, yypos+size (!str_val))))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction46(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction17(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction17(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction6(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction6(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction6, yyNO_MATCH))
       ...
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
              else yyAction46(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction5(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction5(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction5, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction15(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction15(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction19(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction19(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction9(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction9(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction9, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction12(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction12(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction13(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction13(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction11(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction11(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction7(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction7, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction7(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction7, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction7, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction10(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction10(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction18(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction14(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction14(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ65(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction8(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction8(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ103(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
              else yyAction46(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ107(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
              else yyAction46(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ46 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ109(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
       ...
       of NONE => yyAction28(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ110(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
...
fun yyQ42 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ112(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
...
fun yyQ24 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction4(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ27(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
              else yyAction4(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"!"
              ...
              then if inp = #"\v"
                  ...
                  then if inp <= #"\b"
                      then yyAction57(strm, yyNO_MATCH)
                      else yyQ9(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp = #" "
              ...
              then if inp = #"\\"
                  then yyQ17(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                  else yyAction57(strm, yyNO_MATCH)
            else if inp = #"|"
              then yyQ9(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
              else yyAction57(strm, yyNO_MATCH)
...
fun yyQ11 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ19(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
            else if inp < #"0"
              then yyAction57(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ19(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\\"
              ...
              then if inp = #"t"
                  then yyQ15(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
                  else yyQ8(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp = #"|"
              then yyQ16(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
              else yyQ8(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"/"
              ...
              then if inp = #"'"
                  ...
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ21(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp = #"["
              then yyAction48(strm, yyNO_MATCH)
            else if inp < #"["
              then if inp = #"<"
...
fun yyQ0 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"-"
              then yyQ5(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp < #"-"
              then if inp = #"!"
                  then yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp < #"!"
                  then if inp = #"\v"
                      then yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                    else if inp < #"\v"
                      then if inp = #"\n"
                          then yyQ4(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                          else yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                    else if inp = #" "
                      then yyQ5(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                      else yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp = #"'"
                  ...
                  then if inp = #"\""
                      then yyQ6(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                      else yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp <= #")"
                  then yyQ5(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                  else yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
              ...
              then if inp = #"0"
                  ...
                  then if inp = #"/"
                      then yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                      else yyQ5(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp = #"<"
                  then yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp < #"<"
                  then yyQ5(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
              ...
              then if inp = #"\\"
                  then yyQ7(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                  else yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ5(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
              else yyQ3(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
...
in
  (case (!(yyss))
   of STR_SEC => yyQ0(!(yystrm), yyNO_MATCH)
